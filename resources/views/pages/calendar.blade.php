...
<main class="min-h-screen pt-8 pb-20 px-4 relative">
    ...
    <div class="text-center mb-12 z-10 relative">
        ...
        <p class="text-[#384D95] opacity-70 font-medium">Catat momen penting & dokumentasikan hari-harimu ✨</p>
    </div>
    ...
    <div class="max-w-5xl mx-auto z-10 relative">
        ...
        <div class="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-white/20 mb-8">
            <h3 class="font-bold text-[#384D95] mb-4">📋 Warna Catatan:</h3>
...
<script>
    ...
    function renderCalendar() {
        ...
        allDays.forEach((day, index) => {
            ...
            dayEl.innerHTML = `
                ...
                ${notes[dateKey] && notes[dateKey].length > 0 ? `<div class="note-indicator">●</div>` : ''}
            `;
    ...
    function displayNotes(date) {
        ...
        if (!dateNotes || dateNotes.length === 0) {
            notesContainer.innerHTML = '<p class="text-[#384D95] opacity-60 text-center py-8">Belum ada catatan untuk hari ini 📝</p>';
            return;
        }
        ...
        dateNotes.forEach((note, index) => {
            ...
            noteEl.innerHTML = `
                ...
                <div class="flex gap-2 mt-3 justify-end">
                    <button class="edit-btn text-xs px-3 py-1 rounded bg-white/50 hover:bg-white font-bold transition-all" data-index="${index}">✏️ Edit</button>
                    <button class="delete-btn text-xs px-3 py-1 rounded bg-red-500/20 text-red-600 hover:bg-red-500/30 font-bold transition-all" data-index="${index}">🗑️</button>
                </div>
            `;
